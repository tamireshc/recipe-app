  ...
  return (
    <div className="bg-stone-100 h-screen">
      <h1
        ...
        className="bg-stone-500 p-4 text-white font-alice text-3xl text-center"
      >
        {dataInProgress.strMeal}{" "}
      </h1>
      {linkCopy && (
      ...
      <div className="flex md:flex-row flex-col items-center md:items-start p-6 justify-center mb-12">
        ...
        <div className="px-8">
          <p data-testid="recipe-category" className="font-alice text-xl mb-3">
            ᐅ {dataInProgress.strCategory}
          </p>
          ...
          <p data-testid="instructions" className="text-justify mb-4 max-w-xl">
            {dataInProgress.strInstructions}
          </p>
