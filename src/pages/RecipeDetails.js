...
function RecipeDetails() {
  ...
  return (
    <section className="bg-stone-100">
      ...
      <h3 data-testid="recipe-category" className="text-center font-alice text-xl underline text-red-800 mb-2">
        {rd.strCategory}
      ...
      <p data-testid="instructions" className='text-sm font-thin w-64 text-justify h-44 overflow-scroll mt-2'>{rd.strInstructions}</p>
      </div>
      </div>
      </div>
      
      {/* falta implementar direito o vídeo na linha de cima */}
      <p className="text-alice text-2xl text-center bg-stone-200 p-2"> Another Recomendations: </p>
        ...
        {recomendations.map((item, i) => ( // fazer o css e transfar em um carousel, mostrando 2 por vez, e scrolando na horizontal
          ...
          >
            ...
            <img
              ...
              onClick={reload}
            />
            <p data-testid={ `${i}-recomendation-title` } className='font-serif text-center mt-2 text-lg '>
